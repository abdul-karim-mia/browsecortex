...
export function BrainPulse({ size = 18 }: { size?: number }) {
  return (
    <span class="relative inline-flex items-center justify-center" style={{ width: size, height: size }}>
      ...
      <svg viewBox="0 0 128 128" width={size} height={size} class="brain-pulse relative">
        ...
        <g stroke="currentColor" stroke-width="5" stroke-linecap="round" fill="none" class="text-white dark:text-gray-900">
          <path d="M64 40v52" />
        </g>
        <circle cx="46" cy="62" r="3" fill="currentColor" class="synapse-dot text-white dark:text-gray-900" style={{ animationDelay: '0s' }} />
        <circle cx="82" cy="62" r="3" fill="currentColor" class="synapse-dot text-white dark:text-gray-900" style={{ animationDelay: '0.4s' }} />
      </svg>
    </span>
  );
}
