...
export const PROVIDER_SUGGESTIONS: ProviderSuggestion[] = [
  ...
  { name: 'NVIDIA NIM', baseUrl: 'https://integrate.api.nvidia.com/v1', apiKeyUrl: 'https://build.nvidia.com' },
  { name: 'Cohere', baseUrl: 'https://api.cohere.ai/compatibility/v1', apiKeyUrl: 'https://dashboard.cohere.com/api-keys' },
  { name: 'Perplexity', baseUrl: 'https://api.perplexity.ai', apiKeyUrl: 'https://perplexity.ai/settings/api' },
  ...
  { name: 'OpenCode Zen', baseUrl: 'https://opencode.ai/zen/v1', apiKeyUrl: 'https://opencode.ai/zen' },
  { name: 'Ollama Cloud', baseUrl: 'https://ollama.com/v1', apiKeyUrl: 'https://ollama.com/settings/keys' },
